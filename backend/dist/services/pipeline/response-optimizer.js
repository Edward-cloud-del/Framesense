   ...
   */
    ...
    removeRedundancy(response) {
        ...
        if (optimized.webDetection?.webEntities) {
            optimized.webDetection.webEntities = this.removeDuplicateEntities(optimized.webDetection.webEntities);
        }
        if (optimized.textAnnotations) {
            optimized.textAnnotations = this.removeDuplicateTextAnnotations(optimized.textAnnotations);
        }
        return optimized;
    }
    /**
