...
class CostOptimizer {
  ...
  async getAllPossibleRoutes(baseConfig) {
    ...
    switch (questionType) {
      case 'PURE_TEXT':
        routes.push(
          { ...baseConfig, service: 'enhanced-ocr', model: 'tesseract', estimatedCost: 0.0 },
          { ...baseConfig, service: 'google-vision-text', model: 'google-vision', estimatedCost: 0.0015 }
        );
        break;
      ...
      case 'DETECT_OBJECTS':
        routes.push(
          { ...baseConfig, service: 'google-vision-objects', model: 'google-vision', estimatedCost: 0.006 },
          { ...baseConfig, service: 'openai-gpt35-vision', model: 'gpt-3.5-vision', estimatedCost: 0.02 }
        );
        break;
      ...
      case 'DESCRIBE_SCENE':
        routes.push(
          { ...baseConfig, service: 'openai-gpt35-vision', model: 'gpt-3.5-vision', estimatedCost: 0.02 },
          { ...baseConfig, service: 'openai-gpt4-vision', model: 'gpt-4-vision', estimatedCost: 0.04 },
          { ...baseConfig, service: 'google-vision-objects', model: 'google-vision', estimatedCost: 0.006 }
        );
        break;
      ...
      case 'IDENTIFY_CELEBRITY':
        routes.push(
          { ...baseConfig, service: 'google-vision-web', model: 'google-vision', estimatedCost: 0.0035 },
          { ...baseConfig, service: 'openai-gpt4-vision', model: 'gpt-4-vision', estimatedCost: 0.04 }
        );
        break;
    }
      ...
      if (isFreeUser) {
        ...
        if (route.estimatedCost === 0) {
          ...
          effectivenessScore = (
            ...
            speedScore * 0.1 +
            budgetFitScore * 0.0
          ) - 0.3;                 // Penalty for paid services on free tier
        }
      } else {
