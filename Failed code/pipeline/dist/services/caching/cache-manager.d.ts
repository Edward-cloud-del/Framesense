...
declare class CacheManager {
     ...
     */
    createCacheTables(): Promise<void>;
    /**
     ...
     */
    generateKey(imageData: any, question: any, questionType: any, userTier: any): Promise<string | {
        key: any;
        ttl: any;
        compression: any;
        storage: any;
     ...
     */
    get(serviceType: any, imageData: any, options?: {}): Promise<{
        data: any;
        cached: boolean;
        source: string;
        responseTime: number;
     ...
     */
    set(serviceType: any, imageData: any, data: any, options?: {}): Promise<{
        success: boolean;
        cacheKey: any;
        storage: any;
        compressed: boolean;
     ...
     */
    getFromPostgres(cacheKey: any): Promise<any>;
    /**
     * Set in PostgreSQL with compression tracking
     */
    setInPostgres(cacheKey: any, data: any, metadata: any): Promise<boolean>;
    /**
     * Promote frequently accessed items from PostgreSQL to Redis
     */
    promoteToRedis(cacheKey: any, data: any, cacheInfo: any): Promise<void>;
    /**
     ...
     */
    updateAccessStats(cacheKey: any, source: any): Promise<void>;
    /**
