// 🧠 SMART PROMPT OPTIMIZER - Backend Implementation
// ============================================================================
class PromptOptimizer {
    static optimizePrompt(context) {
    ...
    static detectQuestionType(message) {
    ...
    static selectPromptStyle(questionType, context) {
        const styles = {
            code_analysis: {
                name: 'Code Expert',
    ...
    static buildOptimizedPrompt(context, style) {
    ...
    static getSpecificInstructions(context) {
        let instructions = '';
        if (context.hasImage) {
    ...
    static getOptimalTokenCount(questionType) {
        const tokenCounts = {
    ...
    static getOptimalTemperature(questionType) {
        const temperatures = {
    ...
    static matchesKeywords(text, keywords) {
