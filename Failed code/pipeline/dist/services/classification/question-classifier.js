...
class QuestionClassifier {
    ...
    getAvailableQuestionTypes(userTier) {
        return Object.values(this.questionTypes).filter(questionType => this.validateTierAccess(questionType, userTier));
    }
    /**
    ...
    findByCapabilities(requiredCapabilities) {
        return Object.values(this.questionTypes).filter(questionType => {
            return requiredCapabilities.every(cap => questionType.capabilities.includes(cap));
        });
    }
    /**
