...
import { SmartRouter } from '../services/routing/smart-router.js';
import { TierAccess } from '../services/routing/tier-access.js';
import { CostOptimizer } from '../services/routing/cost-optimizer.js';
import { FallbackManager } from '../services/routing/fallback-manager.js';
import { cacheManager } from '../services/caching/index.js';
import responseOptimizer from './response-optimizer.js';
import analyticsTracker from './analytics-tracker.js';
import googleVisionService from '../services/enhanced-services/google-vision.js';
// Enhanced OCR uses CommonJS, we'll create wrapper
import UserService from '../services/user-service.js';
import { AIProcessor } from '../services/ai-processor.js'; // FIXED: Static import instead of dynamic
/**
...
class EnhancedAIProcessor {
  ...
  async initializeEnhancedOCR() {
    try {
      const { EnhancedOCR } = await import('../services/enhanced-services/enhanced-ocr.js');
